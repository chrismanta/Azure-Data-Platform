...
1. From the **Create Azure Cosmos DB Account** screen, create an Azure Cosmos DB Account with the following settings:
    ...
    - In the Instance details of the screen, type in the following information
        ...
        - Leave the remaining options to the default settings
            ...
            ![Creating Azure Cosmos DB in the Azure portal](Images/M04-E01-T01-img01.png)
...
1. In the **Add Container** blade, create a Products database with a container named Clothing with the following settings:
    ...
    - Leave the remaining options with their default values
        ...
        ![Adding a Container in Azure Cosmos DB in the Azure portal](Images/M04-E02-T01-img01.png)
...
1. Copy the following code and paste it into the **Documents** tab:
    ...
    ![Adding data into Cosmos DB using Data Explorer in the Azure portal](Images/M04-E02-T02-img01.png)
...
1. Copy the following code and paste it into the **Items** tab:
    ...
    ![Adding data into Cosmos DB using Data Explorer in the Azure portal](Images/M04-E02-T02-img02.png)
...
1. Click on the **Execute Query** icon. The following result is returned
    ...
    ![Querying data in Cosmos DB using Data Explorer in the Azure portal](Images/M04-E03-T02-img01.png)
...
1. Click on the **Execute Query** icon. The following result is returned
    ...
    ![Querying data in Cosmos DB using Data Explorer in the Azure portal](Images/M04-E03-T02-img02.png)
...
1. Click on the **Execute Query** icon. The following result is returned
    ...
    ![Querying data in Cosmos DB using Data Explorer in the Azure portal](Images/M04-E03-T02-img03.png)
...
1. In the **awcdbstudxx - Data Explorer** window, in the blade,  click on **Replicate data globally**.
    ...
    ![Global replication of Cosmos DB in the Azure portal](Images/M04-E03-T01-img01.png)
...
![Manual Failover of Cosmos DB in the Azure portal](Images/M04-E03-T02-img1.png)
